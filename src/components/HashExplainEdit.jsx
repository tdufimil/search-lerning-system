...
import './HashExplainEdit.css';

function HashExplainEdit(){
  ...
  async function confirm() {
    ...
    navigate("/HashExplain");
  }  

  return(
    
      <div className="hashERoot">
        <div className="haContainer">
          <div className="haExplainEdit">
            <p>説明1:</p>
          ...
          <div className='linkArea'>
            ...
            <p className="toBHashExplain" onClick={() => navigate("/HashExplain", { state: {isCorrectQ1,  isCorrectQ2, isCorrectQ3, isCorrectQ4, mode}})}>解説へ戻る</p>
          </div> 
        </div>
      </div>
...
export default HashExplainEdit
