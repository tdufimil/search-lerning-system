    ...
    <div className="biPraRoot">
      <div className="biPraContainer">
        ...
        <div className="linkArea">
          ...
          {localStorage.getItem('mode') === 'b' ? <p className="toBinaryCode" onClick={() => navigate("/BinaryCode", { state: {isCorrectQ1,  isCorrectQ2, isCorrectQ3, isCorrectQ4}})}>疑似言語での実装へ戻る</p> : <p></p>}
